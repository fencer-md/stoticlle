                    ...
                    <div class="text-right">
                        ...
                        <div class="login-form">
                            ...
                            <div class="form-actions">
                                {{ Form::submit(Lang::get('menu.login'), ['class'=>'btn blue']) }}
                            </div>

                            {{ Form::close() }}
                            <div class="form-actions register-button">
                                {{ Form::submit(Lang::get('menu.register'), ['id'=>'join'])}}
                            </div>
                        </div>
                        {{--
                        <!-- <div class="register"> -->
                        ...
                        <div class="register-form">
                            ...
                            <div class="form-actions">
                                {{ Form::submit(Lang::get('menu.registration'), ['class'=>'btn blue']) }}
                            </div>
                            {{ Form::close() }}
                            {{--
                            <!-- </div> -->
        ...
        @elseif ( Auth::user()->role == "2" )
            <div class="dashboard-user-sliding-menu pull-right">
                <div class="username username-hide-on-mobile pull-left">
                    <span class="greetings">{{trans('menu.greetings')}}</span>
                    <span class="greeting">{{trans('menu.greeting')}}</span>
                    <strong class="first_name">{{ Auth::user()->userInfo->first_name }}</strong>
                    <strong class="last_name"> {{ Auth::user()->userInfo->last_name }}</strong>
                </div>
                ...
                <div class="dashboard-user-slide-menu">
                    <ul class="menu clearfix">
                        ...
                        --}}
                        <li class="user-menu-element">
                            <a href="{{ URL::to('user/announcements') }}">
                                <span class="menu-title">{{trans('menu.bids')}}</span>
                            </a>
                        </li>
                        <li class="user-menu-element visible-xs-block">
                            <a href="{{ URL::to('logout') }}">
                                <span class="menu-title">{{trans('menu.logout')}}</span>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown">
                        <a href="{{ URL::to('logout') }}" class="dropdown-toggle simple-link" title="Выход">
                            <i class="fa fa-sign-out visible-xs-inline-block visible-sm-inline-block"></i><span
                                    class="menu-title hidden-xs hidden-sm">Выход</span>
                        </a>
                    </li>
                </ul>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $(".sidebar-menu-button").on("click", function () {
            ...
            $(".dashboard-user-slide-menu").removeAttr("style").removeClass("active");
