...
@section('content')
	@if(Session::has('msg'))
      ...
      <div class="container-fluid">
        <div class="map col-md-12" id="world_map">
...
-->
    ...
    <section class="content-region site-information">
    	<div class="container">
    		<div class="row">
					<div class="col col-1">
    ...
    <section class="content-region">
      ...
      <section class="columns">
        <div class="container">
          <div class="row">
            <div class="clmn">
              <div class="col-md-12"><div class="title">Jarvis Tech</div>
              <div class="text">
                Вы сами будете контролировать процесс обогащения и в любой момент сможете изменить свое решение. Успех основан на уникальной стратегии в ставках, дающей прибыль в 50-400% в месяц(зависит от количества матчей)...<br><div class="more-info"><a href="{{ $blocks[1]->content->link }}">» узнать больше</a></div>
              </div></div>
            </div>
            <div class="clmn">
            <div class="col-md-12">
              ...
              <div class="text">
                Перед тем как нам начать чтото мы конечно хотели бы описать как мы работаем, и как наше с вами взаимодействие будет происходить, прошу вас ознакомиться с небольшой инструкцией...<br><div class="more-info"><a href="{{ $blocks[1]->content->link }}">» инструкция</a></div>
              </div>
            </div>
            </div>
            <div class="clmn">
