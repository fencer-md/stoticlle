    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle simple-dropdown" data-toggle="dropdown" data-hover="dropdown"
           data-close-others="true">
            <span class="menu-title">{{trans('adminMenu.configTitle')}}</span>
            <i class="fa fa-angle-down"></i>
        </a>
        <ul class="dropdown-menu">
            <li>
                <a href="{{ URL::to('admin/config/rate') }}">{{trans('adminMenu.config.rate')}}</a>
            </li>
            <li>
                <a href="{{ URL::to('admin/config/announcements') }}">{{trans('adminMenu.config.announcements')}}</a>
            </li>
        </ul>
    </li>
    <li class="dropdown">
